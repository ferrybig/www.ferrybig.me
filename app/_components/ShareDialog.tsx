...
const definitions: Definition[] = [
	...
	},
	{
		...
		icon: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" fill="black" height="32" viewBox="0 0 24 24" width="32"><path d="M0 0h24v24H0z" fill="none"/><path d="M 20,4 4,4 C 2.9,4 2.01,4.9 2.01,6 L 2,18 c 0,1.1 0.9,2 2,2 l 16,0 c 1.1,0 2,-0.9 2,-2 L 22,6 C 22,4.9 21.1,4 20,4 z m 0.508475,14.508475 -17.0169495,0 0,-10.7118648 L 12,12.79661 20.508475,7.7966102 z M 11.694915,11 3.4915255,5.4915255 l 17.0169495,0 z"/></svg>',
	},
	{
		title: 'Sms',
		link: (url, title) => `sms:?&body=${encodeURIComponent(title + '\n' + url)}`,
		icon: 'data:image/svg+xml,<svg fill="black" height="36" viewBox="0 0 24 24" width="36" xmlns="http://www.w3.org/2000/svg"><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 11H7V9h2v2zm4 0h-2V9h2v2zm4 0h-2V9h2v2z"/><path d="M0 0h24v24H0z" fill="none"/></svg>',
	},
	{
		title: 'Copy',
		action: (url, title) => {
		...
		<div className={show ? classes.webShareReady : classes.webShare} onClick={(e) => {
			...
			<div className={classes.webShareContainer}>
				...
				{definitions.map(({ title, icon, link, action }) => {
					...
					return link ? (
						<a key={title} href={link(href, pageTitle)} className={classes.webShareItem} target="_blank" rel="noopener" onClick={onClose}>
							{children}
						</a>
					) : (
						<div key={title} className={classes.webShareItem} onClick={() => {
							action?.(href, pageTitle);
							onClose();
						}}>
							{children}
						</div>
